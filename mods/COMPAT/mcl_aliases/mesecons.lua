...
minetest.register_alias("mesecons:mesecon_torch", "mcl_redstone:torch_on")
minetest.register_alias("mesecons:torch", "mcl_redstone:torch_on")
minetest.register_alias("mesecons:pressure_plate_stone", "mcl_redstone:pressure_plate_stone_off")
minetest.register_alias("mesecons:pressure_plate_wood", "mcl_redstone:pressure_plate_wood_off")
minetest.register_alias("mesecons:pressure_plate_birchwood", "mcl_redstone:pressure_plate_birchwood_off")
minetest.register_alias("mesecons:pressure_plate_acaciawood", "mcl_redstone:pressure_plate_acaciawood_off")
minetest.register_alias("mesecons:pressure_plate_darkwood", "mcl_redstone:pressure_plate_darkwood_off")
minetest.register_alias("mesecons:pressure_plate_sprucewood", "mcl_redstone:pressure_plate_sprucewood_off")
minetest.register_alias("mesecons:pressure_plate_junglewood", "mcl_redstone:pressure_plate_junglewood_off")
