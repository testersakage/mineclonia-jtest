...
local spawn_only_peaceful = minetest.settings:get_bool("only_peaceful_mobs", false)
...
function mcl_mobs.spawn_setup(def)
	...
	if (mcl_vars.difficulty <= 0 or spawn_only_peaceful) and not mob_def.persist_in_peaceful then return end
