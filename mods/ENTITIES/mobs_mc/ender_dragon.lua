...
mcl_mobs.register_mob("mobs_mc:enderdragon", {
	...
	on_die = function(self, pos, cmi_cause)
		if self._portal_pos then
			...
			mcl_structures.place_structure(self._portal_pos,mcl_structures.registered_structures["end_exit_portal_open"],PseudoRandom(minetest.get_mapgen_setting("seed") % 32768),-1)
