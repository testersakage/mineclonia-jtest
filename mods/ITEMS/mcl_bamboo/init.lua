...
mcl_trees.register_wood("bamboo",{
	...
	leaves = false,
	tree = { tiles = {"mcl_bamboo_bamboo_bottom.png", "mcl_bamboo_bamboo_bottom.png","mcl_bamboo_bamboo_block.png" }, _mcl_rectangle_crafting = { item = "group:bamboo_tree", width = 3, height = 3 } },
