...
core.register_node("mcl_banners:standing_banner", {
	...
	groups = {axey=1,handy=1, attached_node = 1, not_in_creative_inventory = 1, banner = 1, not_in_craft_guide = 1, material_wood=1, dig_by_piston=1, flammable=-1, unmovable_by_piston = 1, jigsaw_preserve_meta = 1, jigsaw_construct = 1, breaking_cactus = 1},
	stack_max = 16,
	sounds = node_sounds,
...
core.register_node("mcl_banners:hanging_banner", {
	...
	groups = {axey=1,handy=1, attached_node = 1, not_in_creative_inventory = 1, banner = 1, not_in_craft_guide = 1, material_wood=1, flammable=-1, unmovable_by_piston = 1, jigsaw_preserve_meta = 1, jigsaw_construct = 1, breaking_cactus = 1},
	stack_max = 16,
	sounds = node_sounds,
	drop = "", -- Item drops are handled in entity code
