...
minetest.register_globalstep(function(dtime)
	...
	for _,pl in pairs(minetest.get_connected_players()) do
		...
		if pl and not pl:get_player_control().sneak and not mcl_enchanting.has_enchantment(armor_feet, "frost_walker") and not mcl_potions.has_effect(pl, "fire_proof") then
			burn_in_campfire(pl)
		end
	end
