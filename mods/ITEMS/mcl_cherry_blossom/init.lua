...
mcl_trees.register_wood("cherry_blossom",{
	...
	tree_schems= {
		...
		{file=modpath.."/schematics/mcl_cherry_blossom_tree_bee_nest_1.mts", can_grow = mcl_trees.has_flowers},
		{file=modpath.."/schematics/mcl_cherry_blossom_tree_bee_nest_2.mts", can_grow = mcl_trees.has_flowers},
		{file=modpath.."/schematics/mcl_cherry_blossom_tree_bee_nest_3.mts", can_grow = mcl_trees.has_flowers},
	},
