...
mcl_trees.register_wood("cherry_blossom",{
	...
	tree_schems= {
		...
		{file=modpath.."/schematics/mcl_cherry_blossom_tree_beehive_1.mts", can_grow = mcl_trees.has_flowers},
		{file=modpath.."/schematics/mcl_cherry_blossom_tree_beehive_2.mts", can_grow = mcl_trees.has_flowers},
		{file=modpath.."/schematics/mcl_cherry_blossom_tree_beehive_3.mts", can_grow = mcl_trees.has_flowers},
	},
