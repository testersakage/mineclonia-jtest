...
local descriptions = dofile(minetest.get_modpath(modname).."/descriptions.lua")
...
for color,colordef in pairs(mcl_dyes.colors) do
	...
	local sdesc_hc = descriptions.terracotta[color]
	local sdesc_gt = descriptions.glazed_terracotta[color]
	local sdesc_cp = descriptions.concrete_powder[color]
	local sdesc_c = descriptions.concrete[color]
