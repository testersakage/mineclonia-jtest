...
for n, desc in pairs(n_desc) do
	...
	minetest.register_node("mcl_copper:bulb"..n.."_on", {
		...
		groups = {pickaxey = 2, building_block = 1, not_in_creative_inventory = 1, not_conductive = 1, comparator_signal = 15},
		sounds = mcl_sounds.node_sound_metal_defaults(),
		_mcl_blast_resistance = 6,
		_mcl_hardness = 3,
	...
	minetest.register_node("mcl_copper:bulb"..n.."_off", {
		...
		is_ground_content = false,
		groups = {pickaxey = 2, building_block = 1, not_conductive = 1, comparator_signal = 0 },
		sounds = mcl_sounds.node_sound_metal_defaults(),
		_mcl_blast_resistance = 6,
		_mcl_hardness = 3,
