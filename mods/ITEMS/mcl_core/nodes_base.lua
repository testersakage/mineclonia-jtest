...
core.register_node("mcl_core:dirt_with_grass", {
	...
	palette = "mcl_core_palette_grass_4dir.png",
	palette_index = 0,
	color = "#8EB971",
	...
	groups = {
		...
		compostability=30, biomecolor4dir=1, converts_to_moss=1,
	},
	drop = "mcl_core:dirt",
...
core.register_node("mcl_core:podzol", {
	...
	groups = {handy=1, shovely=1, dirt=2, soil=1, soil_sapling=2, soil_sugarcane=1, soil_bamboo = 1, soil_fungus=1, enderman_takable=1, building_block=1, supports_mushrooms=1, converts_to_moss=1, random4dir=1},
	drop = "mcl_core:dirt",
	sounds = mcl_sounds.node_sound_dirt_defaults(),
	on_construct = function(pos)
		replace_random4dir(pos)
