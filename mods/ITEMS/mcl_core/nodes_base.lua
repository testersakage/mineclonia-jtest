...
core.register_node("mcl_core:stone", {
	...
	groups = {pickaxey=1, stone=1, building_block=1, material_stone=1, stonecuttable = 1, converts_to_moss = 1, overworld_carvable = 1, stone_ore_target = 1, },
...
core.register_node("mcl_core:dirt_with_grass", {
	...
	groups = {
		...
		soil=1, soil_sapling=2, soil_flower=1, soil_generic_plant=1, soil_sugarcane=1, soil_bamboo=1, soil_fungus=1, cultivatable=2,
...
core.register_node("mcl_core:mycelium", {
	...
	groups = { handy=1, shovely=1, dirt=2, spreading_dirt_type=1, enderman_takable=1, building_block=1, soil_flower=1, soil_generic_plant=1, soil_sapling=2, soil_sugarcane=1, soil_bamboo=1, soil_fungus=1, mycelium=1, supports_mushrooms=1, converts_to_moss=1 },
	drop = "mcl_core:dirt",
	sounds = mcl_sounds.node_sound_dirt_defaults({
		footstep = {name="default_grass_footstep", gain=0.1},
	}),
...
core.register_node("mcl_core:podzol", {
	...
	groups = {handy=1, shovely=1, dirt=2, soil=1, soil_flower=1, soil_generic_plant=1, soil_sapling=2, soil_sugarcane=1, soil_bamboo = 1, soil_fungus=1, enderman_takable=1, building_block=1, supports_mushrooms=1, converts_to_moss=1},
	drop = "mcl_core:dirt",
	sounds = mcl_sounds.node_sound_dirt_defaults(),
	on_construct = mcl_core.on_snowable_construct,
	_on_shovel_place = mcl_core.make_dirtpath,
...
core.register_node("mcl_core:dirt", {
	...
	groups = {handy=1, shovely=1, dirt=1, soil=1, soil_flower=1, soil_generic_plant=1, soil_sapling=2, soil_sugarcane=1, soil_bamboo=1, soil_fungus=1, cultivatable=2, enderman_takable=1, building_block=1, converts_to_moss=1, converts_to_mud=1},
	sounds = mcl_sounds.node_sound_dirt_defaults(),
	_on_shovel_place = mcl_core.make_dirtpath,
...
core.register_node("mcl_core:coarse_dirt", {
	...
	groups = { handy=1, shovely=1, dirt=3, soil=1, soil_flower=1, soil_generic_plant=1, soil_sugarcane=1, soil_bamboo=1, soil_fungus=1, cultivatable=1, enderman_takable=1, building_block=1, soil_sapling=2, converts_to_moss=1, converts_to_mud=1},
	sounds = mcl_sounds.node_sound_dirt_defaults(),
	_on_shovel_place = mcl_core.make_dirtpath,
	_on_bottle_place = 	mcl_core.bottle_dirt,
	_mcl_hardness = 0.5,
...
core.register_node("mcl_core:clay", {
	...
	groups = {handy=1,shovely=1, enderman_takable=1, building_block=1, soil_flower=1},
...
for i=1,8 do
	...
	core.register_node(id, {
		...
		node_box = node_box,
		groups = {shovely=1, attached_node=1, deco_block=1, dig_by_water=1, dig_by_piston=1, snow_cover=1, top_snow=i, unsticky = 1, pathfinder_partial = i < 4 and 1 or 2, snow_layer=1, not_breaking_cactus = 1, },
