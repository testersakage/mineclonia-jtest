...
for i=1,8 do
	...
	core.register_node(id, {
		...
		node_box = node_box,
		groups = {shovely=1, attached_node=1, deco_block=1, dig_by_water=1, dig_by_piston=1, snow_cover=1, top_snow=i, unsticky = 1, pathfinder_partial = i < 4 and 1 or 2, snow_layer=1,},
