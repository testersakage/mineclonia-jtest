...
mcl_trees.register_wood("oak",{
	...
	tree_schems= {
		...
		{ file = modpath.."/schematics/mcl_core_oak_classic_bee_nest.mts", can_grow = mcl_trees.has_flowers},
...
mcl_trees.register_wood("birch",{
	...
	sign_color="#AA907A",
	tree_schems = {
		{ file = modpath.."/schematics/mcl_core_birch_bee_nest.mts", can_grow = mcl_trees.has_flowers },
