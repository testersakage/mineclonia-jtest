...
function mcl_doors:register_door(name, def)
	...
	minetest.register_craftitem(":"..name, {
		...
		on_place = function(itemstack, placer, pointed_thing)
			...
			local pt2 = vector.copy(pt):offset(0, 1, 0)
	...
	minetest.register_node(":"..name.."_b_1", {
		...
		after_destruct = function(bottom, _)
			...
			if meta_bottom:get_int("rotation") == 1 then
				...
				local top = vector.copy(bottom):offset(0, 1, 0)
	...
	minetest.register_node(":"..name.."_t_1", {
		...
		after_destruct = function(top, oldnode)
			...
			if meta_top:get_int("rotation") == 1 then
				...
				local bottom = vector.copy(top):offset(0, -1, 0)
