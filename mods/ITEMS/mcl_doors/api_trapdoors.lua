...
function mcl_doors:register_trapdoor(name, def)
	...
	local function punch(pos)
		...
		if minetest.get_item_group(me.name, "trapdoor") == 2 then
			minetest.sound_play(def.sound_close, {pos = pos, gain = 0.1, max_hear_distance = 16}, true)
			tmp_node = {name=name, param1=me.param1, param2=me.param2}
		-- Open
		else
			minetest.sound_play(def.sound_open, {pos = pos, gain = 0.1, max_hear_distance = 16}, true)
