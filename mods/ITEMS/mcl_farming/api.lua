...
function mcl_farming.register_simple_crop(id, defs, overrides)
    ...
    if mod ~= "mcl_farming" and defs.register_on_mcl_farming then mod_prefix = ":" end
    ...
    for i = 1, defs.stages do
        ...
        core.register_node(mod_prefix .. name, table.merge(tpl_crop, {
            ...
            on_construct = function(pos)
                ...
                meta:set_string("mcl_farming:crop_id", id)
                meta:set_int("mcl_farming:current_stage", i)
            end,
            selection_box = {
