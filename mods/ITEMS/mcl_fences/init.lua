...
-- Node box
local p = { -0.125, -0.5001, -0.125, 0.125, 0.5001, 0.125 }
local x1 = { -0.5001, 0.25, -0.0625, -0.125, 0.4375, 0.0625 }
local x12 = { -0.5001, -0.125, -0.0625, -0.125, 0.0625, 0.0625 }
local x2 = { 0.125, 0.25, -0.0625, 0.5001, 0.4375, 0.0625 }
local x22 = { 0.125, -0.125, -0.0625, 0.5001, 0.0625, 0.0625 }
local z1 = { -0.0625, 0.25, -0.5001, 0.0625, 0.4375, -0.125 }
local z12 = { -0.0625, -0.125, -0.5001, 0.0625, 0.0625, -0.125 }
local z2 = { -0.0625, 0.25, 0.125, 0.0625, 0.4375, 0.5001 }
local z22 = { -0.0625, -0.125, 0.125, 0.0625, 0.0625, 0.5001 }
...
local tpl_fence_gates = {
	...
	node_box = {
		type = "fixed",
		fixed = {
			{ -0.5001, -0.1875, -0.0625, -0.375, 0.5001, 0.0625 },
			{ 0.375, -0.1875, -0.0625, 0.5001, 0.5001, 0.0625 },
			{ -0.125, -0.125, -0.0625, 0, 0.4375, 0.0625 },
			{ 0, -0.125, -0.0625, 0.125, 0.4375, 0.0625 },
			{ -0.5001, 0.25, -0.0625, -0.125, 0.4375, 0.0625 },
			{ -0.5001, -0.125, -0.0625, -0.125, 0.0625, 0.0625 },
			{ 0.125, 0.25, -0.0625, 0.5001, 0.4375, 0.0625 },
			{ 0.125, -0.125, -0.0625, 0.5001, 0.0625, 0.0625 }
		}
	},
	collision_box = {
		type = "fixed",
...
local tpl_fence_gates_open = {
	...
	node_box = {
		...
		fixed = {
			{ -0.5001, -0.1875, -0.0625, -0.375, 0.5001, 0.0625 },
			{ 0.375, -0.1875, -0.0625, 0.5001, 0.5001, 0.0625 },
			{ -0.5001, 0.25, 0.0625, -0.375, 0.4375, 0.375 },
			{ -0.5001, -0.125, 0.0625, -0.375, 0.0625, 0.375 },
			{ 0.375, 0.25, 0.0625, 0.5001, 0.4375, 0.5001 },
			{ 0.375, -0.125, 0.0625, 0.5001, 0.0625, 0.5001 },
			{ -0.5001, -0.125, 0.375, -0.375, 0.4375, 0.5001 },
			{ 0.375, 0.0625, 0.5001, 0.5001, 0.25, 0.375 }
		}
	},
	selection_box = {
		type = "fixed",
