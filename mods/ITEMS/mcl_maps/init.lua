...
local function get_node_name_raw(x, y, z)
	local content, param1, param2, pos_ok = core.get_node_raw(x, y, z)
	if not pos_ok then return "ignore", 0, 0 end
	return core.get_name_from_content_id(content), param1, param2
end
