...
minetest.register_node("mcl_nether:magma", {
	...
	on_walk_over = function(_, _, player)
		...
		if player and player:get_player_control().sneak or mcl_enchanting.has_enchantment(armor_feet, "frost_walker") or mcl_status_effects.is_active(player, "fire_resistance") then
			return
		end
