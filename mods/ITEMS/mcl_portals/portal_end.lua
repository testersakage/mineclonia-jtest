...
minetest.register_node("mcl_portals:end_portal_frame", {
	...
	groups = { creative_breakable = 1, deco_block = 1, end_portal_frame = 1, unmovable_by_piston = 1, _mcl_partial = 2},
...
minetest.register_node("mcl_portals:end_portal_frame_eye", {
	...
	groups = { creative_breakable = 1, deco_block = 1, comparator_signal = 15, end_portal_frame = 2, not_in_creative_inventory = 1, unmovable_by_piston = 1, _mcl_partial = 2},
