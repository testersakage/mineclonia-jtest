...
core.register_node("mcl_portals:portal_end", {
	...
	groups = {portal=1, not_in_creative_inventory = 1, disable_jump = 1, unmovable_by_piston = 1, wither_immune = 1},
...
core.register_node("mcl_portals:end_portal_frame", {
	...
	groups = { creative_breakable = 1, deco_block = 1, end_portal_frame = 1, unmovable_by_piston = 1, pathfinder_partial = 2, wither_immune = 1},
...
core.register_node("mcl_portals:end_portal_frame_eye", {
	...
	groups = { creative_breakable = 1, deco_block = 1, comparator_signal = 15, end_portal_frame = 2, not_in_creative_inventory = 1, unmovable_by_piston = 1, pathfinder_partial = 2, wither_immune = 1},
