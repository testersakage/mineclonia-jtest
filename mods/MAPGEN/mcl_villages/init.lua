...
minetest.register_node("mcl_villages:building_block", {
	...
	on_timer = function(pos, elapsed)
		...
		local is_abandoned = meta:get_int("is_abandoned") > 0 and true or false
		...
		mcl_villages.post_process_building(minp, maxp, blockseed, has_beds, has_jobs, is_belltower, bell_pos, is_abandoned)
		return false
	end,
})
