# Mineclonia Tools
This directory is for tools and scripts for Mineclonia.
...
a texture pack for Minetest so it can be used with Mineclonia.
...
- Can update the Mineclonia textures
...
This is a Python script which list every single global tables in mineclonia source code.
...
Usage:
- In the console, run `python3 ./tools/create_luacheck.py` in the Mineclonia directory
