...
def main():
    ...
    parser = argparse.ArgumentParser(description=f"This is the official Mineclonia Texture Converter. This will convert textures from Minecraft resource packs to a Minetest texture pack. Supported Minecraft version: {SUPPORTED_MINECRAFT_VERSION} (Java Edition)")
